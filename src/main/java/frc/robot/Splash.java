...
class Splash {
  ...
  public static boolean printAllStatusFiles(String... splashLines) {
    ...
    System.out.println("====================================================================");
    System.out.println("====================================================================");
    System.out.println("Starting robotInit for Howdy bots 6377");
    ...
    try {
      ...
      try {
        for (int length = 0; (length = statusfile.read(buffer)) != -1; ) {
          ...
          field =
              tab.add(fn, "").withPosition(colIndex, rowIndex).withSize(widthIndex, 1).getEntry();
          field.setString(buf);
        }
      } finally {
        System.out.println();
